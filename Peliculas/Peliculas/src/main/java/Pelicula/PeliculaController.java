...
public class PeliculaController {
    ...
    @PostMapping ("/addAll")
    public List<Pelicula> createAllPelicula(@RequestBody List<Pelicula> peliculaList){
    ...
    public Pelicula updatePelicula(@PathVariable Long id, @RequestBody Pelicula peliculaActualizado){
