...
public class InventarioController {
    ...
    @PostMapping ("/addAll")
    public List<Inventario> createAllInventario(@RequestBody List<Inventario> inventarioList){
    ...
    public Inventario updateInventario(@PathVariable Long id, @RequestBody Inventario inventarioActualizado){
