...
public class TiendaController {
    ...
    @PostMapping("/add")
    public void createTienda(@RequestBody Tienda tienda){
        tiendaRepository.save(tienda);
    }

    @PostMapping ("/addAll")
    public List<Tienda> createAllTienda(@RequestBody List<Tienda> tiendaList){
    ...
    public Tienda updateTienda(@PathVariable Long id, @RequestBody Tienda tiendaActualizado){
