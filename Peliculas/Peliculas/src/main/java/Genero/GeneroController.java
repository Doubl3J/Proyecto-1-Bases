...
public class GeneroController {
    ...
    @PostMapping("/add")
    public void createGenero(@RequestBody Genero genero){
        generoRepository.save(genero);
    }

    @PostMapping ("/addAll")
    public List<Genero> createAllGenero(@RequestBody List<Genero> generoList){
    ...
    public Genero updateGenero(@PathVariable Long id, @RequestBody Genero generoActualizado){
