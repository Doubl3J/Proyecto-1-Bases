...
public class ProvinciaController {
    ...
    @PostMapping("/add")
    public void createGenero(@RequestBody Provincia provincia){
        provinciaRepository.save(provincia);
    }

    @PostMapping ("/addAll")
    public List<Provincia> createAllProvincia(@RequestBody List<Provincia> provinciaList){
    ...
    public Provincia updateProvincia(@PathVariable Long id, @RequestBody Provincia provinciaActualizado){
