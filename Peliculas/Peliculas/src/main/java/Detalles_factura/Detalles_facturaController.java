...
public class Detalles_facturaController {
    ...
    @PostMapping("/add")
    public void createDetalles(@RequestBody Detalles_factura detalles){
        detallesRepository.save(detalles);
    }

    @PostMapping ("/addAll")
    public List<Detalles_factura> createAllDetalles(@RequestBody List<Detalles_factura> detallesList){
    ...
    public Detalles_factura updateDetalles(@PathVariable Long id, @RequestBody Detalles_factura detallesActualizado){
